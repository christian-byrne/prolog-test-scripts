...
test(four_board, [true(subset([[1/2, 2/4, 3/1, 4/3], [1/3, 2/1, 3/4, 4/2]], SolutionList))]) :-
...
test(twleve_board1, [true]) :- placement([1/1,2/3,3/6,4/8,5/11,6/5,7/12,8/10,9/4,10/7,11/9,12/2], 12), !.
test(twelve_board3, [true]) :- placement([1/3,2/1,4/9,3/6,5/12,6/10,7/4,8/2,9/5,10/8,11/11,12/7], 12), !.
